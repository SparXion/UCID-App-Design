...
const embedding_1 = require("../src/recommendation/embedding");
...
async function main() {
    ...
    const testStudent = await prisma.student.create({
        data: {
            ...
            email: "test@uc.edu",
            year: 2,
            embedding: JSON.stringify((0, embedding_1.getMockEmbedding)("Talents: Drawing, Spatial Awareness | Interests: Footwear, Design"))
        }
    });
    console.log("\n✅ Seed complete!");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
